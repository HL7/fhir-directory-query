...
Instance: health-or-human-services-endpoint
...
* name = "HealthHumanServicesConformanceExpectations"
* text.div = "<div></div>"
* title = "Conformance expectations for federated Health and Human Services Directory"
* date = "2022-09-21"
...
| Network | SHALL | [http://hl7.org/fhir/us/directory-query/2022Sep/StructureDefinition-NatlDirEndpointQry-Network.html](http://hl7.org/fhir/us/directory-query/2022Sep/StructureDefinition-NatlDirEndpointQry-Network.html) | coverage-area, name |  
