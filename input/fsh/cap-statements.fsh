...
//care team
* rest[0].resource[11].supportedProfile[0].extension.valueCode = #MAY
//endpoint
...
//care team
* rest[0].resource[11].supportedProfile[0].extension.valueCode = #SHOULD
//endpoint
* rest[0].resource[0].supportedProfile[0].extension.valueCode = #SHALL
//healthcare service
...
* rest[0].resource[6].supportedProfile[0].extension.valueCode = #SHOULD
//Practitioner
* rest[0].resource[7].supportedProfile[0].extension.valueCode = #MAY
//PractitionerRole
* rest[0].resource[8].supportedProfile[0].extension.valueCode = #SHOULD
//network
* rest[0].resource[4].supportedProfile[0].extension.valueCode = #SHOULD
//Insurance Plan
* rest[0].resource[2].supportedProfile[0].extension.valueCode = #MAY
