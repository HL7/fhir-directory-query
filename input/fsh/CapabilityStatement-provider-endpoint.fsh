...
//Provider
Instance: provider-endpoint
InstanceOf: CapabilityStatement
Usage: #definition
* description = "Capabilities for a Federated Query Server for a Provider where endpoint search capabilities are met"
* name = "ProviderDirectoryConformanceExpectations"
* text.div = "<div></div>"
* title = "Conformance expectations for federated Provider Directory"
* date = "2022-09-21"
...
| Organization | MAY | [http://hl7.org/fhir/us/directory-query/2022Sep/StructureDefinition-NatlDirEndpointQry-Organization.html](http://hl7.org/fhir/us/directory-query/2022Sep/StructureDefinition-NatlDirEndpointQry-Organization.html) | type, address, endpoint, identifier, name, partOf |     |     |     |
